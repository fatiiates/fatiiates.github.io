        ...
        <div className="sidebar" >
            <div>
                <div className="social-link">
                    <a href="https://medium.com/@fatiiates" target="_blank" rel="noopener noreferrer" title="Twitter">
                ...
                <div>
                    <a href="/doc/resume_en.pdf" target="_blank" rel="noopener noreferrer" title="Stackoverflow">
