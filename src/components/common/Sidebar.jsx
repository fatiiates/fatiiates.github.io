  ...
  render() {
    return (
      <div className="sidebar">
        <div>
          <div
            onClick={() => this.clicking("Link", "Calendly görüntülendi")}
            onAuxClick={() => this.clicking("Link", "Calendly görüntülendi")}
          ...
          <div
            onClick={() => this.clicking("Link", "Github görüntülendi")}
            onAuxClick={() => this.clicking("Link", "Github görüntülendi")}
            className="social-link"
          >
            <a
          ...
          <div
            onClick={() => this.clicking("Link", "Gmail görüntülendi")}
            onAuxClick={() => this.clicking("Link", "Gmail görüntülendi")}
            className="social-link"
          >
            <a
          ...
          <div
            onClick={() => this.clicking("Link", "Linkedin görüntülendi")}
            onAuxClick={() => this.clicking("Link", "Linkedin görüntülendi")}
            className="social-link"
          >
            <a
          ...
          <div
            onClick={() => this.clicking("Link", "Stackoverflow görüntülendi")}
            onAuxClick={() => this.clicking("Link", "Stackoverflow görüntülendi")}
            className="social-link"
          >
            <a
          ...
          <div
            onClick={() => this.clicking("Link", "Özgeçmiş görüntülendi")}
            onAuxClick={() => this.clicking("Link", "Özgeçmiş görüntülendi")}
            className="social-link"
          >
            <a
              href="/doc/resume.pdf"
          ...
          <div
            onClick={() => this.clicking("Link", "Medium görüntülendi")}
            onAuxClick={() => this.clicking("Link", "Medium görüntülendi")}
            className="social-link"
          >
            <a
            ...
            >
              <svg
                ...
                height="24"
              >
                <path d="M 18.998047 15 A 17.002 17.002 0 0 0 18.998047 49.003906 A 17.002 17.002 0 0 0 18.998047 15 z M 45.498047 16 A 8.502 16.002 0 0 0 45.498047 48.003906 A 8.502 16.002 0 0 0 45.498047 16 z M 58.5 17 A 3.5 15.002 0 1 0 58.5 47.003906 A 3.5 15.002 0 1 0 58.5 17 z" />
              </svg>
            </a>
          </div>
        </div>
